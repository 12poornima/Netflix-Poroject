    ...
    return (
        <div className='mid-session' >
            ...
            <div>
                ...
                <div className='paras'>
                    <p className='para' >New to Netflix? <a href="#" className='link-sign' >Sign up now</a></p>
                    <p className='para2' >This page is protected by Google reCAPTCHA <br /> to ensure you're not a bot. <a href="#"> Learn more.</a></p>
                </div>
            </div>
        </div>
    )
